<header class="bg-white dark:bg-gray-800 shadow-md px-6 py-3 flex justify-between items-center sticky top-0 z-10">
    <div class="flex items-center space-x-4">
        ...
        <h2 id="page-title" class="text-xl font-semibold text-gray-800 dark:text-gray-200">Dashboard</h2>
    </div>
    <div class="flex items-center space-x-6">
        ...
        <div class="relative">
            <button id="avatar-btn" class="flex items-center text-gray-600 dark:text-gray-200 hover:text-primary focus:outline-none" aria-haspopup="true" aria-expanded="false">
                <img src="https://via.placeholder.com/40" alt="Admin avatar" class="w-8 h-8 rounded-full border-2 border-gray-300 dark:border-gray-600 mr-2">
                <span>Admin</span>
            ...
            <div id="avatar-dropdown" class="hidden absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg py-1 z-10" role="menu">
                <a href="#" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700" role="menuitem">Change Password</a>
                <a href="#" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700" role="menuitem">Logout</a>
            </div>
        </div>
    </div>
</header>